class Game {
    ...
    var obstaclesPositions = [
      ...
      { x: width / 2 - 180, y: height - 2300, image: obstacle1Image },
      { x: width / 2, y: height - 2800, image: obstacle1Image },
      { x: width / 2 - 180, y: height - 3300, image: obstacle1Image },
      { x: width / 2 + 180, y: height - 3300, image: obstacle1Image },
      { x: width / 2 + 250, y: height - 3800, image: obstacle1Image },
      { x: width / 2 - 150, y: height - 4300, image: obstacle1Image },
      { x: width / 2 + 250, y: height - 4800, image: obstacle1Image },
      { x: width / 2, y: height - 5300, image: obstacle1Image },
      { x: width / 2 - 180, y: height - 5500, image: obstacle1Image }
    ];
